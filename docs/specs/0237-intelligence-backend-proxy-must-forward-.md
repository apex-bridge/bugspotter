...
8. **`intelligenceRoutes`'s exported function signature must not change at all.** Current, exact, on `main` (`packages/backend/src/api/routes/intelligence.ts:168-173`):
   ```ts
